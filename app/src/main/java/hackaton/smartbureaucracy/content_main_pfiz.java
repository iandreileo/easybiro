...
public class content_main_pfiz extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_content_main_pfiz);
    ...
    public void submit(View view) {
        ...
        //mergem la prima activitate
         Intent i = new Intent(content_main_pfiz.this, MainActivity.class);       // Specify any activity here e.g. home or splash or login etc
